...
def interfaceConfig(obj,deviceType, prompt,timeout,interfaceArg1,interfaceArg2,interfaceArg3,interfaceArg4,
                    interfaceArg5, interfaceArg6, interfaceArg7, interfaceArg8, interfaceArg9):
    retVal = ""
    command = "interface "
    newPrompt = prompt
    if(interfaceArg1 == "PortChannel"):
    ...
    if(interfaceL2Arg1 == "aggregation-group"):
        ...
        if(value =="ok"):
            if(interfaceL2Arg2 == "echo"):
                ...
                if(value =="ok"):
                    command = command + interfaceL2Arg3 + " "
                    if(interfaceL2Arg3 == "keyed-md5" or interfaceL2Arg3 == "keyed-sha1" or interfaceL2Arg3 == "meticulous-keyed-md5"
                       or interfaceL2Arg3 == "meticulous-keyed-sha1" or interfaceL2Arg3 == "simple"):
                        ...
                        if(value == "ok"):
                            ...
                            if(interfaceL2Arg4 == "key-chain"):
                                ...
                                if(value == "ok"):
                                    command = command + interfaceL2Arg5 + " key "
                ...
                if(value =="ok"):
                    ...
                    if(interfaceL2Arg3 == "authentication"):
                        ...
                        if(value =="ok"):
                            command = command + interfaceL2Arg4 + " "
                            if(interfaceL2Arg4 == "keyed-md5" or interfaceL2Arg4 == "keyed-sha1" or
                               interfaceL2Arg4 == "meticulous-keyed-md5" or interfaceL2Arg4 == "meticulous-keyed-sha1"
                               or interfaceL2Arg4 == "simple"):
            ...
            if(interfaceL2Arg2 == "access-group"):
                ...
                if(interfaceL2Arg3 == "client"):
                    ...
                    if(interfaceL2Arg4 == "class-id"):
                        command = command + interfaceL2Arg3 + " "
                        if(interfaceL2Arg4 != None):
                            command = command + interfaceL2Arg4
                    elif(interfaceL2Arg4 == "request"):
                        command = command + interfaceL2Arg4 + " "
                        if(interfaceL2Arg5 == "bootfile-name" or interfaceL2Arg5 == "host-name" or interfaceL2Arg5 == "log-server"
                           or interfaceL2Arg5 == "tftp-server-name"):
                            command = command + interfaceL2Arg5 + " "
                        else:
                            retVal = "Error-250"
                            return retVal
        ...
        if(value == "ok"):
            ...
            if(interfaceL2Arg2 == "address"):
                if(interfaceL2Arg3 == "dhcp"):
                    ...
                    if(value == "ok"):
                        command = command + interfaceL2Arg3 + " "
                        if(interfaceL2Arg4 == "anycast" or interfaceL2Arg4 == "secondary" or interfaceL2Arg4 == None ):
                            command = command + interfaceL2Arg4
                        else:
                            retVal = "Error-276"
                            return retVal
...
def portChannelConfig(obj, deviceType, prompt, timeout, portChArg1, portChArg2, portChArg3, portChArg4, portChArg5, portChArg6, portChArg7):
    retVal = ""
    command = ""
...
def routerConfig(obj, deviceType, prompt, timeout,protocol, asNum, routerArg1, routerArg2, routerArg3, routerArg4, routerArg5,
                routerArg6, routerArg7, routerArg8):
    retVal = ""
...
def bgpNeighborAFConfig(obj, deviceType, prompt, timeout, bgpNeighborAFArg1, bgpNeighborAFArg2, bgpNeighborAFArg3):
    ...
    if(bgpNeighborAFArg1 == "allowas-in"):
        ...
        command = command + bgpNeighborAFArg1 + " "
        if(bgpNeighborAFArg2 != None and bgpNeighborAFArg2 == "route-map"):
            command = command + bgpNeighborAFArg2 + " "
        ...
        command = command + bgpNeighborAFArg1 + " "
        if(bgpNeighborAFArg2 != None and bgpNeighborAFArg2 == "extended"):
            command = command + bgpNeighborAFArg2
        else:
            command = command
...
def bgpNeighborConfig(obj, deviceType, prompt, timeout, bgpNeighborArg1, bgpNeighborArg2, bgpNeighborArg3, bgpNeighborArg4, bgpNeighborArg5):
    ...
    if(bgpNeighborArg1 == "address-family"):
        ...
        command = command + bgpNeighborArg1 + " "
        if(bgpNeighborArg2 != None and bgpNeighborArg2 == "mutihop"):
        ...
        if(value == "ok"):
            command = command + bgpNeighborArg2 + " "
            if(bgpNeighborArg3 != None and bgpNeighborArg3 == "no-prepend"):
                command = command + bgpNeighborArg3 + " "
                if(bgpNeighborArg4 != None and bgpNeighborArg4 == "replace-as"):
                    command = command + bgpNeighborArg4 + " "
                    if(bgpNeighborArg5 != None and bgpNeighborArg5 == "dual-as"):
...
def bgpAFConfig(obj, deviceType, prompt, timeout, bgpAFArg1, bgpAFArg2, bgpAFArg3, bgpAFArg4, bgpAFArg5, bgpAFArg6):
    ...
    if(bgpAFArg1 == "aggregate-address"):
        ...
        if(bgpAFArg2 == "synchronization"):
            ...
            if(value == "ok"):
                command = command + bgpAFArg2 + " "
                if(bgpAFArg3 != None and bgpAFArg3 == "backdoor"):
                    command = command + bgpAFArg3
                elif(bgpAFArg3 != None and bgpAFArg3 == "route-map"):
                    command = command + bgpAFArg3
                    value = checkSanityofVariable(deviceType, "addrfamily_routemap_name", bgpAFArg4)
                    if(value == "ok"):
                        command = command + bgpAFArg4 + " "
                        if(bgpAFArg5 != None and bgpAFArg5 == "backdoor"):
                ...
                if(value == "ok"):
                    ...
                    if(bgpAFArg3 != None and bgpAFArg3 == "backdoor"):
                        ...
                        if(value == "ok"):
                            ...
                            retVal = "Error-196"
                            return retVal
                    elif(bgpAFArg3 != None and bgpAFArg3 == "mask"):
                        command = command + bgpAFArg3
...
def vlanAccessMapConfig(obj, deviceType, prompt, timeout, vlanArg3, vlanArg4, vlanArg5):
    retVal = ""
    #Wait time to get response from server
    timeout = timeout
    command = ""
    if(vlanArg3 == "action"):
        command = command + vlanArg3 + " "
        value = checkSanityofVariable(deviceType, "vlan_accessmap_action", vlanArg4)
        if(value == "ok"):
        ...
        if(vlanArg4 == "ip" or vlanArg4 == "mac"):
            ...
            value = checkSanityofVariable(deviceType, "vlan_access_map_name", vlanArg5)
            if(value == "ok"):
...
def vlagConfig(obj, deviceType, prompt, timeout, vlagArg1, vlagArg2, vlagArg3, vlagArg4):
    ...
    if(vlagArg1 == "enable") :
        ...
        command = command + vlagArg1 +" "
        value = checkSanityofVariable(deviceType, "vlag_auto_recovery", vlagArg2)
        if(value == "ok"):
        ...
        command = command + vlagArg1 +" "
        value = checkSanityofVariable(deviceType, "vlag_config_consistency", vlagArg2)
        if(value == "ok"):
            command = command + vlagArg2
        else:
            retVal = "Error-161"
        ...
        value = checkSanityofVariable(deviceType, "vlag_port_aggregation", vlagArg2)
        if(value == "ok"):
            command = command + vlagArg2
        else:
            retVal = "Error-162"
        ...
        command = command + vlagArg1 +" "
        value = checkSanityofVariable(deviceType, "vlag_startup_delay", vlagArg2)
        if(value == "ok"):
            command = command + vlagArg2
        else:
            retVal = "Error-164"
        ...
        if(value == "ok"):
            ...
            if(vlagArg3 != None):
                ...
                value = checkSanityofVariable(deviceType, "vlag_port_aggregation", vlagArg3)
                if(value == "ok"):
        ...
        #debugOutput("hlthchk")
        command = command + vlagArg1 +" "
        value = checkSanityofVariable(deviceType, "vlag_hlthchk_options", vlagArg2)
        if(value == "ok"):
            if(vlagArg2 == "keepalive-attempts"):
                value = checkSanityofVariable(deviceType, "vlag_keepalive_attempts", vlagArg3)
                if(value == "ok"):
                ...
                value = checkSanityofVariable(deviceType, "vlag_keepalive_interval", vlagArg3)
                if(value == "ok"):
                    command = command+vlagArg2 +" "+vlagArg3
                else:
                    retVal = "Error-168"
                ...
                value = checkSanityofVariable(deviceType, "vlag_retry_interval", vlagArg3)
                if(value == "ok"):
                    command = command+vlagArg2 +" "+vlagArg3
                else:
                    retVal = "Error-169"
                ...
                value = checkSanityofVariable(deviceType, "vlag_peerip", vlagArg3)
                if(value =="ok"):
                    command = command+vlagArg2 +" "+vlagArg3
                    if(vlagArg4 != None):
                        value = checkSanityofVariable(deviceType, "vlag_peerip_vrf", vlagArg4)
                        if(value == "ok"):
...
#Tuning of timeout parameter is pending
def doSecureStartupConfigBackUp(protocol, timeout, confServerIp, confPath, confServerUser, confServerPwd, obj) :
    #server = "10.241.105.214"
    server = confServerIp
...
#This method supports only SCP or SFTP
#Tuning of timeout parameter is pending
def doSecureRunningConfigRollback(protocol, timeout, confServerIp, confPath, confServerUser, confServerPwd, obj) :
    #server = "10.241.105.214"
    server = confServerIp
...
def enterEnableModeForDevice(enablePassword, timeout, obj):
    ...
    while (flag == False):
        ...
        try:
            ...
            if(gotit != -1):
                time.sleep(1)
                if(enablePassword == None or enablePassword == ""):
                    return "\n Error-106"
...
def checkSanityofVariable(deviceType, variableId, variableValue):
    ...
    ruleString = getRuleStringForVariable(ruleFile, variableId)
    retVal = validateValueAgainstRule(ruleString, variableValue)
    return retVal
#EOM

def getRuleStringForVariable(ruleFile, variableId):
    retVal = ""
...
def validateValueAgainstRule(ruleString, variableValue):
    ...
    if(variableType == "INTEGER"):
        ...
        if(checkInteger(variableValue)!=True):
            return "Error-111"
        ...
        r = range(long(long_range[0].strip()), long(long_range[1].strip()))
        val_range = variableValue.split('-')
        if((checkLong(val_range[0]) != True) or (checkLong(val_range[1]) != True)):
            return "Error-117"
        ...
        if(variableValue == ""):
            return "Error-118"
        if(True == isinstance(variableValue, str)):
            return "ok"
        else:
            return "Error-119"
        ...
        if(isinstance(variableValue,str) != True):
            return "Error-119"
        result = False
